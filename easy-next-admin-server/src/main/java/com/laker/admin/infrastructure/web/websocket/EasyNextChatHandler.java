package com.laker.admin.infrastructure.web.websocket;

import com.laker.admin.infrastructure.observability.actuator.metrics.websocket.WebsocketMetrics;
...
@Service
@Slf4j
public class EasyNextChatHandler extends AbstractWebSocketHandler {
    private final Map<String, WebSocketSession> webSocketSessionMap = new ConcurrentHashMap<>();
    WebsocketMetrics websocketMetrics;

    public EasyNextChatHandler(WebsocketMetrics websocketMetrics) {
